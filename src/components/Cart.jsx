      ...
      <div className="flex justify-center py-10  bg-[#F6F5F5]">
        <div className="flex flex-col gap-3">
          {cartProduct.map((cartProduct, index) => (
            <div className="shadow-2xl h-[250px] w-[480px] bg-[white]">
              <div className="flex bg-[white]">
                <div className="pr-5">
                  <Link to={`/view/${cartProduct?.id}`}>
                    <img
                      className="w-20 m-10 transitiion duration-300 hover:scale-[1.2] cursor-pointer"
              ...
              <div className="flex items-center justify-center ml-32 bg-[white]">
